...
{
    public class YabbiPostProcessBuildiOS
    {
#if !UNITY_2019_3_OR_NEWER
        private const string UnityMainTargetName = "Unity-iPhone";
#endif

        private static readonly List<string> DynamicLibrariesToEmbed = new()
        {
            "YabbiSDK.xcframework",
            "SspnetCore.xcframework",
            "SspnetDsp.xcframework",
            "YabbiConsentManager.xcframework",
            "SspnetConsentManager.xcframework"
        };
        ...
        public static void YabbiPostProcessPbxProject(BuildTarget buildTarget, string buildPath)
        {
